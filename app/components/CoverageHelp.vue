...
.coverage-help summary { align-items: center; color: var(--color-ink-600); cursor: pointer; display: inline-flex; font-size: .82rem; font-weight: 700; gap: .35rem; list-style: none; }
...
.coverage-help-panel strong { color: var(--color-ink-950); font-size: .82rem; }
.coverage-help-panel span { color: var(--color-ink-600); font-size: .78rem; line-height: 1.55; }
